            ...
            <div class="flex justify-between border-b-2 border-gray-100">
                ...
                <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                    ...
                    <span
                        ...
                        <i class="ph-moon-stars-fill text-3xl h-6 w-6 text-gray-50 hidden lg:block hover:dark:text-yellow-400 hover:text-yellow-400"
                           v-if="$colorMode.value === 'dark'" />
                        <i class="ph-sun-dim-fill text-3xl h-6 w-6 hidden lg:block hover:dark:text-yellow-400 hover:text-yellow-400"
