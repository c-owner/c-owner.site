...
<!--                top area -->
                <div class=" flex items-center text-black">
                    <div class="text-3xl font-noto-sans-kr font-medium dark:text-white pr-40">비밀번호 찾기</div>
                    <button @click="closeModal()" class="ml-auto -mx-1.5 -my-1.5 text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:scale-110 duration-700 focus:outline-none">
                        <i class="ph-x-circle-fill text-3xl text-blue-darken-4 dark:text-indigo-400 dark:text-white vertical-bottom" />
                    </button>
                </div>
...
<!--                content area -->
                <form @submit.stop.prevent="findAction()" method="post" class="mt-8 space-y-6">
                    ...
                    <button type="submit" class="w-full font-d2-coding text-center ml-auto text-gray-50 hover:text-white rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 bg-indigo-600 dark:bg-gradient-to-r dark:from-indigo-500 hover:bg-indigo-800 dark:text-gray-200 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700">
                        찾기
                    </button>
