    ...
    <div>
        <dialog-box @rehide="rehide" dismiss-text="무시하고 닫기" :hide="hideDialog">
            ...
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                <h3 class="text-xl font-medium leading-6 text-red-700 dark:text-red-400" id="modal-title">경고</h3>
                <div class="mt-2">
                    ...
                    <div class="text-sm mt-5 text-link">
                        <NuxtLink  to="/login">로그인</NuxtLink>
                    </div>
                    <div class="text-sm mt-5 text-link">
                        <NuxtLink  to="/register">계정이 없으십니까? <span class="">가입하기</span></NuxtLink>
                    </div>
                        ...
                        <li>
                            <a href="#"
                               class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <span class="flex-1 ml-3 whitespace-nowrap">Corner DM</span>
                                <span
                        ...
                        <li>
                            <a href="#"
                               class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <span class="flex-1 ml-3 whitespace-nowrap">받은편지함</span>
                                <span
                        ...
                        <li>
                            <a href="#"
                               class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <span class="flex-1 ml-3 whitespace-nowrap">후원</span>
                            </a>
                        </li>
                        <li>
                            <a href="#"
                               class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <span class="flex-1 ml-3 whitespace-nowrap">이슈 건의</span>
                            </a>
                        </li>
                    </ul>
